	...
	_callItem(customFunction){
		...
		setTimeout(function(){
			...
			if (this._clickEventListener != undefined) {
				this._clickEventListener(ECtxMenuNames.item);
			}
		}.bind(this), 1);
	}
}

export function CtxMenu(element){
